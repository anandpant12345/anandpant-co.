      ...
      <div class="container">
        ...
        <div class="plans-dropdown-container" style="position: relative; display: inline-block;">
          ...
          <div class="plans-dropdown-menu" style="display: none; position: absolute; top: 100%; left: 50%; transform: translateX(-50%); background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 8px 0; min-width: 160px; z-index: 100; box-shadow: 0 10px 25px rgba(0,0,0,0.15); margin-top: 8px;">
            <a href="#/services/individual" onclick="window.navigateTo('#/services/individual'); this.parentNode.style.display='none'; this.parentNode.previousElementSibling.querySelector('.arrow-svg').style.transform='rotate(0deg)'; event.stopPropagation();" style="display: flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 20px; color: #0f172a; font-size: 0.95rem; text-decoration: none; font-weight: 600; text-align: center; transition: background 0.2s;" onmouseover="this.style.background='#f1f5f9';" onmouseout="this.style.background='transparent';">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#2563eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
              Individual
            </a>
            <a href="#/services/business" onclick="window.navigateTo('#/services/business'); this.parentNode.style.display='none'; this.parentNode.previousElementSibling.querySelector('.arrow-svg').style.transform='rotate(0deg)'; event.stopPropagation();" style="display: flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 20px; color: #0f172a; font-size: 0.95rem; text-decoration: none; font-weight: 600; text-align: center; transition: background 0.2s;" onmouseover="this.style.background='#f1f5f9';" onmouseout="this.style.background='transparent';">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#2563eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><path d="M9 22v-4h6v4"></path><path d="M8 6h.01M16 6h.01M12 6h.01M12 10h.01M8 10h.01M16 10h.01M12 14h.01M8 14h.01M16 14h.01"></path></svg>
              Business
            </a>
          </div>
        </div>
